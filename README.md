...
This package is based on [bican/roles](https://github.com/romanbican/roles), 
I made some corrections because the developer of the code 
stopped uploading  updates and in some Laravel versions it generated 
mistakes.
...
'providers' => [
     ...
     */
    Clandro\Roles\RolesServiceProvider::class,
...
Publish the package config file and migrations to your application. Run these commands inside your terminal.
    ...
    php artisan vendor:publish --provider="Clandro\Roles\RolesServiceProvider" --tag=config
    php artisan vendor:publish --provider="Clandro\Roles\RolesServiceProvider" --tag=migrations
...
```php
use Clandro\Roles\Traits\HasRoleAndPermission;
use Clandro\Roles\Contracts\HasRoleAndPermission as HasRoleAndPermissionContract;
...
```php
use Clandro\Roles\Models\Permission;
...
protected $routeMiddleware = [
    ...
    'role' => \Clandro\Roles\Middleware\VerifyRole::class,
    'permission' => \Clandro\Roles\Middleware\VerifyPermission::class,
    'level' => \Clandro\Roles\Middleware\VerifyLevel::class,
];
```
...
It throws `\Clandro\Roles\Exceptions\RoleDeniedException`, `\Clandro\Roles\Exceptions\PermissionDeniedException` or `\Clandro\Roles\Exceptions\LevelDeniedException` exceptions if it goes wrong.
...
{
    if ($e instanceof \Clandro\Roles\Exceptions\RoleDeniedException) {
...
For more information, please have a look at [HasRoleAndPermission](https://gitlab.com/amgtronics/roles/blob/master/src/amgtronics/roles/Contracts/HasRoleAndPermission.php) contract.
